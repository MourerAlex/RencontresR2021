...
library(PCAmixdata)
## Package pour la visu de dendrogramme
library(dendextend)
...
## Les groupes sont définis sur les variables: on affecte à chaque modalité le groupe à laquelle la variable d'où elle provient appartient
